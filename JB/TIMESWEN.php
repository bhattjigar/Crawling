...
define('MAX_FILE_SIZE', 99999999999999999999999);
// helper functions
// -----------------------------------------------------------------------------
...
function file_get_html($url, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
{
    ...
    // $contents = file_get_contents($url, $use_include_path, $context, $offset);
     ...
     $ch = curl_init();
                  ...
                  $__header[0] = "Accept: text/xml,application/xml,application/xhtml+xml,";
                  $__header[0] .= "text/html;q=0.9,text/plain;q=0.8,image/png,*/*;q=0.5";
                  $__header[] = "Cache-Control: max-age=0";
                  $__header[] = "Connection: keep-alive";
                  $__header[] = "Keep-Alive: 300";
                  $__header[] = "Accept-Charset: ISO-8859-1,utf-8;q=0.7,*;q=0.7";
                  $__header[] = "Accept-Language: en-us,en;q=0.5";
                  $__header[] = "Pragma: ";
                  ...
                  curl_setopt($ch, CURLOPT_HTTPHEADER, $__header);
